...
(function(mod) {
  ...
  var IsCreated = infer.constraint({
    ...
    infer.registerFunction("klassified_subclass", function(_self, args, argNodes) {
		if (argNodes && argNodes.length && argNodes[0].params) {
			console.log("Object!!!!!!!!!!!!!!!!!");
			return new infer.Fn("ffoo", new infer.AVal, [], new infer.AVal);
